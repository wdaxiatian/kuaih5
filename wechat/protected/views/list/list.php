...
<div id="content-header">
  ...
  <h2>订单列表</h2>
	<!--<a class="btn btn-info" href="<?php echo U('rand/Getexcel',array('star'=>$star,'end'=>$end))?>"  style="float:right; margin-right:100px;">导出当前表</a> -->
</div>
    ...
    <div class="span12">
		<div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Data table</h5>
		  <form id="tform" action="<?php echo U('list/list')?>" method="post">
			...
			<input class="btn btn-success" type="button" onClick='ck()'; style="padding: 4px 10px;margin:-4px 0 0 10px;" value="查询">
			</form>
          </div>
...
<script>
	...
	$("tbody").load("<?php echo U('list/listajax')?>",{'page':page,'star':star,'end':end,'status':status},function() {
		});
	function ck(){
		var status = $("#status").find("option:selected").val(); 
