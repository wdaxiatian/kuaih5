...
<div id="content-header">
  ...
  <h2>订单列表</h2>
	<a class="btn btn-info" href="<?php echo U('list/Getexcel7',array('star'=>$star,'end'=>$end))?>"  style="float:right; margin-right:100px;">导出当前表</a>
</div>
    ...
    <div class="span12">
		<div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Data table</h5>
		  <form id="tform" action="<?php echo U('list/togo')?>" method="post">
...
<script>
	...
	var status =0;
	$("tbody").load("<?php echo U('list/listajax7')?>",{'page':page,'star':star,'end':end,'status':status},function() {
		});
	function ck(){
		var status = 0;
