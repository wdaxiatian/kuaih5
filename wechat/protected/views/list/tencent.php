...
<div id="content">
    <div id="content-header">
        ...
        <h2>列表</h2>
        <a class="btn btn-info" href="<?php echo U('list/Getexcel19',array('star'=>$star,'end'=>$end))?>"  style="float:right; margin-right:100px;">导出当前表</a>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        <h5>Data table</h5>
                        <form id="tform" action="<?php echo U('list/tencent')?>" method="post">
...
<script>
    ...
    $("tbody").load("<?php echo U('list/listajax19')?>",{'page':page,'star':star,'end':end},function() {
    });
    function ck(){
        var star = $("input[name=star]").val();
        var end = $("input[name=end]").val();
